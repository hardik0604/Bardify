...
export default function Footer() {
  return (
    <footer className="w-full mt-32 pb-8 border-t border-border-glass pt-8 flex flex-col md:flex-row items-center justify-between text-text-muted text-sm font-sans px-8">
